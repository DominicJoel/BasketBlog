                    ...
                    <nav className="navbar navbar-expand-lg navbar-inverse  fixed-top" id="mainNav" >
                            ...
                            <div className="collapse navbar-collapse" id="navbarResponsive" >
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" href="/addBlog">Create Post</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href='/posted'>Posted</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href='/Login' onClick={this.signOut}>Sign Out</a>
                                </li>
                                </ul>
                    ...
                    <div className="col-md-12">
                        <div className="well well-sm">
                            <form className="form-horizontal" method="post" noValidate  ref="form">
                                <fieldset>
                                    <legend className="text-center header"><h1> New Post </h1> </legend>
